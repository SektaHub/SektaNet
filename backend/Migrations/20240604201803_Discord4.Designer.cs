...
namespace backend.Migrations
{
    ...
    [Migration("20240604201803_Discord4")]
    partial class Discord4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.Discord.Emoji", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.OwnsMany("backend.Models.Discord.Reaction", "Reactions", b1 =>
                        {
                            ...
                            b1.HasOne("backend.Models.Discord.Emoji", "Emoji")
                                .WithMany()
